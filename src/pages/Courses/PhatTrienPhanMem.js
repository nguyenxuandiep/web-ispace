...
function PhatTrienPhanMem() {
    return (
        <div>
            ...
            <div>
                <div className="text-center p-8" style={{ width: '80%', margin: '20px auto' }}>
                    <h6>
                        <h3
                            className="text-orange-500 text-xl font-semibold"
                            style={{ color: '#f57e25', margin: '5px auto' }}
                        >
                            Tại iSPACE, ngành phát triển phần mềm được thiết kế tối thiểu 500 giờ trải nghiệm thực tế
                            dưới sự hướng dẫn của doanh nghiệp. Sinh viên sẽ được rèn luyện kĩ năng chuyên môn, tích lũy
                            kinh nghiệm thông qua quá trình học tập tại doanh nghiệp cùng các sản phẩm có khả năng được
            ...
            <div>
                <div className="text-center p-8 text-3xl font-bold">LỘ TRÌNH HỌC</div>
            ...
            <div className="mt-7" style={{ width: '80%', margin: '0 auto' }}>
                <div className="text-center p-8 text-3xl font-bold">NỘI DUNG CHƯƠNG TRÌNH HỌC</div>
                <section className=" flex flex-wrap justify-center items-center mt-2">
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="flex">
                            ...
                            <div className="p-4">
                                <p>
                                    <span style={{ fontSize: '16px' }}>– Ngôn ngữ lập trình C#/Java/PHP</span>
                                    <br />
                ...
                <section className=" flex flex-wrap justify-center items-center mt-2">
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="flex">
                            ...
                            <div className="p-4">
                                <p>
                                    <span style={{ fontSize: '16px' }}>– Phân tích và thiết kế phần mềm</span>
                                    <br />
                ...
                <section className=" flex flex-wrap justify-center items-center mt-2">
                    <div className="w-full md:w-1/2">
                        <img
                            ...
                            class="attachment-large size-large wp-image-11758"
                            alt="rượu vang shop"
